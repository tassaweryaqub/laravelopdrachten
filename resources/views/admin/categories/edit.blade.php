...
<form id="form"  class="w-full max-w-lg" action="{{ route('categories.update', ['category' => $category->id]) }}" method="POST">
    ...
    @csrf 
      ...
      <div class="w-full md:w-1/2 px-3">
        ...
        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('lastname') border-red-500 @enderror"  value="{{ old('lastname', $category->lastname) }}"name="lastname" id="lastname"  type="text" placeholder="Jane" required  >
      </div>
    </div>
